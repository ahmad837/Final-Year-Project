  ...
  return (
    ...
    <br/>
      ...
      <Grid item md={6} xs={12}>
        ...
        <img style={{margin:'0px auto',height:225,maxHeight:600,maxWidth:500,borderRadius:20}}
         src={newsCover === undefined || '' ? 'https://fyp3.blob.core.windows.net/fyp/No_Image.jpg' : 
